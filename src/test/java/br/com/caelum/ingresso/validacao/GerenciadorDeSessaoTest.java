...
public class GerenciadorDeSessaoTest {
	...
	@Test
	public void garenteQueNaoDevePermitirSessaoNoMesmoHOrario(){
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
		Assert.assertFalse(gerenciador.cabe(sessaoDasDez));
	}
	@Test
	public void garanteQueNaoDevePermitirSessoesTerminandoDentroDoHorarioDeUmaSessaoJaExixtente(){
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
...
//	@Test(expected=IllegalStateException.c)
//	public void deveLancarExcecaoSeListaExistenteForVazia(){
//		List<Sessao> sessoes = Arrays.asList();
//		GerenciadorDeSessao gerenciador = new GerenciadorDeSessao(sessoes);
//		gerenciador.cabe(sessaoDasTreze);
//	}
